...
class TestSubject
{
    ...
    public function noTypeParam($param = 'fallback')
    {
    }

    public function noTypeNoDefault($param)
    {
    }

    public function intersectionType(SomeClass & SampleInterface $mixed)
    {
    }

    public function nonExistentType(\ThisClassDoesNotExist $x)
    {
    }

    public function unionWithNothingResolvableButDefault(array|string $val = 'fallback')
    {
    }

    public function unresolvableUnion(\Imaginary1|\Imaginary2 $val)
    {
    }

    public function pureEnum(SomeEnum $e = SomeEnum::FOO)
    {
    }
    public function untypedEnumDefault($e = SomeEnum::FOO)
    {
    }

    public function untypedObjectDefault($x = new \stdClass())
    {
    }
}
